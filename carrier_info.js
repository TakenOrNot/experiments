...
!function () {
    ...
    $('body').append("<div id='blueflagcarrierinfo' style='position: absolute;left: 50%;margin-left: -205px; top: 1em;color: white;height: 35px;width: 100px;text-align: right;'></div><div id='redflagcarrierinfo' style='position: absolute;right: 50%; margin-right: -205px; top: 1em;color: white;height: 35px;width: 100px;'></div>");
